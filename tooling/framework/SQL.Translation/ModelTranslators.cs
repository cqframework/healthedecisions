...
{
    // SQL Translation assumes model classes referenced in the input ELM can be directly translated to table references in SQL where the name of the table is the name of the
    // class.
	...
	public class PatientTranslator : ModelTranslator, IModelTranslator
	{
		...
		{
 			return (ObjectType)SQLModel.DataTypes.ResolveType(typeof(AllscriptsModel.Patient));
		}
    ...
    public class AddressTranslator : ModelTranslator, IModelTranslator
    {
        ...
        public ObjectType TransformModel(TranslationContext context, ObjectType sourceType)
        {
 			return (ObjectType)SQLModel.DataTypes.ResolveType(typeof(AllscriptsModel.StructuredAddress));
        }
	...
	public class AllergyTranslator : ClinicalItemBaseTranslator, IModelTranslator
	{
		...
		public ObjectType TransformModel(TranslationContext context, ObjectType sourceType)
		{
			return (ObjectType)SQLModel.DataTypes.ResolveType(typeof(AllscriptsModel.Allergy));
		}
	...
	public class EncounterTranslator : ClinicalItemBaseTranslator, IModelTranslator
	{
		...
		public ObjectType TransformModel(TranslationContext context, ObjectType sourceType)
		{
 			return (ObjectType)SQLModel.DataTypes.ResolveType(typeof(AllscriptsModel.Encounter));
		}
	...
	public class ResultTranslator : ClinicalItemBaseTranslator, IModelTranslator
	{
		...
		public ObjectType TransformModel(TranslationContext context, ObjectType sourceType)
		{
 			return (ObjectType)SQLModel.DataTypes.ResolveType(typeof(AllscriptsModel.Result));
		}
	...
	public class ProblemTranslator : ClinicalItemBaseTranslator, IModelTranslator
	{
		...
		public ObjectType TransformModel(TranslationContext context, ObjectType sourceType)
		{
 			return (ObjectType)SQLModel.DataTypes.ResolveType(typeof(AllscriptsModel.Problem));
		}
	...
	public class ProcedureTranslator : ClinicalItemBaseTranslator, IModelTranslator
	{
		...
		public ObjectType TransformModel(TranslationContext context, ObjectType sourceType)
		{
 			return (ObjectType)SQLModel.DataTypes.ResolveType(typeof(AllscriptsModel.Procedure));
		}
